...
router.get('/', function(req, res, next) {
  ...
  p1:"Thanks for visiting this website. Here you can look my portfolio. You can find the services that I provide at a decent price and also some interesting projects that I have done or working on. Moreover, you can contact me just clicking the contact on the navigation bar and submitting the form."
...
router.get('/projects', function(req, res, next) {
  ...
  p3:"Last semester, we got an assignment in which we had to make a bug smasher gaming website. In this project when the user click on the bug the score increased by 5 and the speed of bug relocation is increased with each click. In this small game, we used html, css and jquery. ",
  one:"1.",
  two:"2.",
  three:"3."
});
